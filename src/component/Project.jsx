...
export const Project = () => {
  return (
    ...
    >
      ...
      <p className="animate-fade-in-up delay-1 max-w-2xl text-sm sm:text-lg text-[#8C8595]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-7xl mt-10">
        {projects.map((project, index) => (
          <Reveal
            ...
            delay={(index % 3) + 1}
            className="
              group w-full rounded-3xl bg-[#1F1924] overflow-hidden
          ...
          >
            ...
            <div className="flex flex-col items-start px-6 pt-5 pb-6">
              ...
              <p className="text-sm sm:text-md text-[#8C8595] mt-3 text-left">
                {project.description}
              </p>
              ...
              <div className="flex flex-wrap gap-3 mt-4">
                {project.tech.map((item, techIndex) => (
                  <button
                    key={techIndex}
                    className="
                      text-white px-3 py-1 bg-[#2E2735] rounded-lg text-xs
                      transition-all duration-300
                      hover:bg-linear-to-r hover:from-[#9E49C5] hover:to-[#DC519B]
